...
def task(cookie):
    ...
    payload2 = "pageNo=1&pageSize=20&pin=XTYXRGTpqcAKPURPsbAQzE7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w%3D%3D&name=%E4%BA%92%E5%8A%A8"
    ...
    try:
        response = requests.post(url=url_gwc, headers=headers, data=payload2)
        result = response.json()
        hd_lists = result['data']['homeInfoResultVOList']

        for _list in hd_lists:
